        ...
        <div className="flex items-center">
          {ready && authenticated ? (
            <>
              ...
              <button className="w-[120px] h-11 px-4 py-[8px] rounded-[50px] border border-gray-900 justify-center items-center gap-2.5 inline-flex mr-8" onClick={logout}>Logout</button>
            </>
          ) : (
            <button
              onClick={login}
