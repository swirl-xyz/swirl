...
export default function Home() {
  return (
    <main className={`flex min-h-screen flex-col ${inter.className}`}>
      <section
        class='relative py-28 bg-white bg-center bg-cover'
      ...
      >
        <div class='mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col lg:flex-row gap-10 lg:gap-12'>
              ...
              <div class='flex sm:flex-row flex-col gap-5 w-full'>
                ...
                >
                  <input
                    ...
                    class='w-full py-3 outline-none opacity-60'
                  />
                  <button
          ...
          <div class='flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl'></div>
        </div>
      </section>
      <section>
        <ProjectSection />
