...
export default function ActivityFeed() {
  ...
  const isHealthcarePage = router.pathname.match(/innovations-in-healthcare/);

  const [title, setTitle] = useState('');
  const [description, setDescription] = useState('');
  const [amount, setAmount] = useState('');
  const [isDonor, setIsDonor] = useState(isHealthcarePage);
  ...
  return (
    <section className="bg-[#F7FBFA] flex justify-center items-center flex-col pb-10">
          ...
          {isDonor ? (
            <>
              ...
              <div className="w-[467px] h-[550px] bg-white rounded-[30px] shadow-xl shadow-orange-600/50 border border-orange-600">
                <div className="mt-8 px-8">
                  ...
                  <div className="flex gap-4">
                    <div className="w-[153px] h-11 px-7 py-[13px] rounded-[50px] border border-gray-900 justify-center items-center gap-2.5 inline-flex">
                      <button type="button" className="text-center text-gray-900 text-base font-medium leading-normal" onClick={() => vote('no')}>
                        ❌ Deny
                      </button>
                    </div>
                    <div className="w-[153px] h-11 px-7 py-[13px] bg-stone-950 rounded-[50px] border border-gray-900 justify-center items-center gap-2.5 inline-flex">
            ...
            <>
              <div className="w-[467px] h-[520px] bg-white rounded-[30px] shadow-md border border-purple-700 shadow-xl  shadow-purple-700/50 hover:border-opacity-75 transition-shadow transition-border">
                <div className="mt-8 px-8">
                  <h2 className="text-4xl font-bold text-gray-700 py-3">
                    Manage Project
                  </h2>
                  <div className="w-[390px] h-11 flex-col justify-start items-start inline-flex mb-5">
                    <div className="justify-start items-start gap-6 inline-flex">
                      ...
                      <div className="flex-col justify-center items-center inline-flex">
                        ...
                        {activeTab === 'withdraw' && (
                          <div className="w-[74px] h-[0px] border-2 border-purple-700" />
                        )}
                      </div>
                        ...
                        <form onSubmit={handleSubmit}>
                          <div>
                            ...
                            <input
                              ...
                              className="block px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 rounded-[100px] w-[360px]"
                            />
                          </div>
                          <div className="mt-6">
                            ...
                            <input
                              ...
                              className="block px-4 py-2 mt-2 mb-5 text-gray-700 placeholder-gray-400 bg-white border border-gray-200  focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 rounded-[100px] w-[360px]"
                            />
                          </div>
                          <div className="mt-6">
                            <div className="flex justify-between mb-2">
                          ...
                          <div className="mt-6">
                            <button className=" px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-black rhover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50  rounded-[100px] w-[360px]">
                        ...
                        <form onSubmit={handleSubmit}>
                          <div>
                            ...
                            <input
                              ...
                              className="block px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 dfocus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 rounded-[100px] w-[360px]"
                            />
                          </div>
                          <div className="mt-6">
                            <div className="flex justify-between mb-2">
                          ...
                          <div className="mt-6">
                            <button className=" px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-black hover:bg-blue-400 focus:outline-none focus:bg-blue-400 focus:ring focus:ring-blue-300 focus:ring-opacity-50 rounded-[100px] w-[360px]">
